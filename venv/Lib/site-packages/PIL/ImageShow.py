...
class Viewer:
    ...
    def get_command(self, file: str, **options: Any) -> str:
        """
        Returns the commands used to display the file.
...
class XDGViewer(UnixViewer):
    """
    The freedesktop.org ``xdg-open`` commands.
    """
...
class DisplayViewer(UnixViewer):
    """
    The ImageMagick ``display`` commands.
...
class GmDisplayViewer(UnixViewer):
    """The GraphicsMagick ``gm display`` commands."""
...
class EogViewer(UnixViewer):
    """The GNOME Image Viewer ``eog`` commands."""
...
class XVViewer(UnixViewer):
    ...
    def get_command_ex(
        ...
        # imagemagick's display commands instead.
